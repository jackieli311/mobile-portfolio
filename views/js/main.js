...
// and columns, and the screensize, and set the maximum count for i to be equal screen size.
window.onload = function() {
  ...
  var elem;
  // Changed the maximum count for the i variable to <40 from <200 because the sliding pizzas in the background won't use all 200.
